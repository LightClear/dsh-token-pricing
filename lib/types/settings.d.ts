...
export declare const TOKEN_PRICING_NAMESPACE = "token-pricing";
/** Accepted peak-window timezone bases. */
export declare const PEAK_TIME_ZONES: readonly ["local", "utc"];
...
export declare const DEFAULT_PEAK_WINDOW: PeakWindow;
 ...
 */
export declare const TokenPricingEntrySchema: z<TokenPricingEntry>;
/** Durable section schema; also the wire envelope the browser scope validates against. */
export declare const TokenPricingSchema: z<TokenPricingSettings>;
